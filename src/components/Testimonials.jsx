    ...
    >
      <div className="shell">
        ...
        >
          <span
            aria-hidden
            className="pointer-events-none absolute -top-12 left-1/2 -translate-x-1/2 font-display text-[9rem] leading-none text-saffron-400/10"
          >
            &ldquo;
          </span>
          ...
          <div className="reveal relative min-h-[19rem] sm:min-h-[16rem]">
            {testimonials.map((t, i) => (
              ...
              >
                <div className="flex gap-1 text-saffron-400" aria-label={`${t.rating} out of 5`}>
                ...
                <figcaption className="mt-8">
                  <div className="font-display text-lg text-saffron-300">{t.name}</div>
            ...
            {testimonials.map((t, i) => (
              <button
                ...
                className={`h-px transition-all duration-500 ${
                  i === index ? 'w-12 bg-saffron-400' : 'w-6 bg-cream-400/35 hover:bg-cream-400/70'
                }`}
              />
            ))}
          </div>

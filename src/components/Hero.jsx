    ...
    <section id="top" className="relative min-h-[100svh] overflow-hidden">
      ...
      <div className="shell relative flex min-h-[100svh] flex-col justify-center pb-16 pt-36">
        <div className="max-w-3xl">
          ...
          <p className="devanagari mt-9 text-3xl text-marigold-300/90 sm:text-4xl">
            {site.nameDevanagari}
          </p>
          ...
          <h1 className="mt-4 font-display text-[3.25rem] font-light leading-[0.95] tracking-tight text-cream-50 sm:text-7xl lg:text-[5.5rem]">
            Every meal,
            <br />
            a small <span className="italic text-marigold-300">ceremony</span>.
          </h1>
        ...
        <div className="mt-20 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.05] lg:grid-cols-4">
          {accolades.map((a) => (
            <div key={a.label} className="bg-masala-950/60 px-6 py-7 backdrop-blur-sm">
              <div className="font-display text-4xl font-light text-marigold-300">{a.value}</div>
      ...
      <div className="pointer-events-none absolute bottom-8 left-1/2 hidden -translate-x-1/2 lg:block">
        <div className="h-14 w-px animate-shimmer bg-gradient-to-b from-transparent via-marigold-400/60 to-transparent" />
      </div>
    </section>
  );
}

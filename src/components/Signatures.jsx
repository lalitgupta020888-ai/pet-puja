          ...
          {signatures.map((dish, i) => (
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-petrol-950 via-petrol-950/35 to-transparent" />
              </div>

              <div className="absolute inset-x-0 bottom-0 p-6">
                <div className="flex items-baseline justify-between gap-3">
                  <h3 className="font-display text-2xl font-normal text-cream-50">{dish.name}</h3>
                  <span className="shrink-0 font-display text-xl text-saffron-300">₹{dish.price}</span>
                </div>
                {/*
              ...
              <span className="absolute left-5 top-5 rounded-full border border-saffron-400/40 bg-petrol-950/60 px-3 py-1 text-[0.6rem] uppercase tracking-widest text-saffron-300 backdrop-blur">
                Signature
              </span>
            </article>
          ))}

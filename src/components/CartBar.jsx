    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 p-4 sm:hidden">
        <button
          type="button"
          onClick={openCart}
          className="flex w-full items-center justify-between gap-4 rounded-2xl bg-terracotta-500 px-5 py-4 text-cream-50 shadow-[0_18px_50px_-12px_rgba(193,85,47,0.7)]"
        >
          <span className="flex items-center gap-3">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-petrol-950/15 text-xs font-bold tabular-nums">
              {count}
            </span>
      ...
      <button
        type="button"
        onClick={openCart}
        className="fixed bottom-24 right-7 z-40 hidden items-center gap-3 rounded-full bg-terracotta-500 py-3.5 pl-4 pr-6 text-cream-50 shadow-[0_18px_50px_-12px_rgba(193,85,47,0.7)] transition-transform duration-300 hover:scale-105 sm:flex"
      >
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-petrol-950/15 text-xs font-bold tabular-nums">
          {count}
        </span>

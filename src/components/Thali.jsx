      ...
      <div className="shell">
          ...
          {thalis.map((t) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`devanagari text-xs ${on ? 'text-masala-900/70' : 'text-marigold-400/70'}`}
                >
                  {t.hi}
                </span>
              </button>
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="reveal relative mx-auto w-full max-w-md">
            <div className="relative aspect-square overflow-hidden rounded-full border border-marigold-400/25 shadow-[0_40px_120px_-40px_rgba(233,161,59,0.5)]">
              <Image
                key={thali.photo}
              ...
              />
              <div className="absolute inset-0 rounded-full bg-gradient-to-t from-masala-950/70 via-transparent to-transparent" />
            </div>
            ...
            <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 rounded-full border border-marigold-400/30 bg-masala-950/90 px-7 py-3 backdrop-blur">
              <span className="font-display text-3xl text-marigold-300">₹{thali.price}</span>
            </div>
          </div>
          ...
          <div className="reveal">
            ...
            <ul className="mt-9 space-y-px overflow-hidden rounded-2xl border border-white/[0.07]">
              {thali.items.map((item) => (
                <li
                  key={item.id}
                  className="flex items-baseline gap-3 bg-masala-950/60 px-5 py-4"
                >
                  <span
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
              ...
              <span className="text-marigold-300">You save ₹{saving} on the set</span>
            </div>

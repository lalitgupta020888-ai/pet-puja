...
const inputClass =
  'w-full rounded-xl border border-white/10 bg-petrol-950/60 px-4 py-3.5 text-cream-100 placeholder:text-cream-400/40 transition-colors focus:border-saffron-400 focus:outline-none';
        ...
        <div className="grid gap-16 lg:grid-cols-[0.95fr_1.05fr] lg:gap-24">
          ...
          <div>
            ...
            <dl className="mt-14 space-y-8">
              {[
                ...
                >
                  <dt className="text-[0.65rem] uppercase tracking-brand text-saffron-400">
                    {row.term}
                  </dt>
          ...
          <div className="reveal surface p-8 sm:p-10">
            ...
            <p className="mt-3 text-sm leading-relaxed text-cream-300/70">
              ...
              <a href={site.phoneHref} className="text-saffron-300 underline underline-offset-4">
                Just call us
              </a>
              .
            </p>
            ...
            {sent ? (
              <div className="mt-10 rounded-2xl border border-saffron-400/30 bg-saffron-400/[0.07] p-8 text-center">
                <p className="font-display text-2xl text-saffron-200">Your email is ready to send</p>

    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 p-4 sm:hidden">
        <button
          type="button"
          onClick={openCart}
          className="flex w-full items-center justify-between gap-4 rounded-2xl bg-gold-400 px-5 py-4 text-wine-950 shadow-[0_18px_50px_-12px_rgba(217,184,106,0.7)]"
        >
          <span className="flex items-center gap-3">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-wine-950/15 text-xs font-bold tabular-nums">
              {count}
            </span>
      ...
      <button
        type="button"
        onClick={openCart}
        className="fixed bottom-24 right-7 z-40 hidden items-center gap-3 rounded-full bg-gold-400 py-3.5 pl-4 pr-6 text-wine-950 shadow-[0_18px_50px_-12px_rgba(217,184,106,0.7)] transition-transform duration-300 hover:scale-105 sm:flex"
      >
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-wine-950/15 text-xs font-bold tabular-nums">
          {count}
        </span>

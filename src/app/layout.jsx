  ...
  return (
    ...
    >
      <body>
        <a
          href="#menu"
          className="sr-only focus:not-sr-only focus:fixed focus:left-6 focus:top-6 focus:z-[100] focus:rounded-full focus:bg-marigold-400 focus:px-5 focus:py-3 focus:text-sm focus:font-semibold focus:text-masala-950"
        >
          Skip to menu
        </a>
        {children}
